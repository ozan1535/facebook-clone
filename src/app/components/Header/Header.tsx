...
function Header() {
  return (
    <div className="w-full h-14 fixed flex items-center justify-between px-4 shadow-md bg-white z-50">
      <div className="flex gap-2">
        ...
        <div className="w-56 h-10 relative">
          <input
            type="text"
            className="w-full h-full rounded-full pl-10 focus:pl-3 transition-all duration-300 peer outline-none bg-gray-200"
          ...
          <Image
            ...
            alt="logo"
            src={"/vector.png"}
            className="absolute left-3 top-3 peer-focus:hidden transition-all duration-500"
          />
        </div>
      </div>
      <div className="hidden lg:block">
        <ul className="flex justify-center items-center">
          <li className="w-24 h-14 flex justify-center items-center border-b-4 border-blue-600 cursor-pointer mx-1">
            <div className="w-full h-5/6 rounded-md flex justify-center items-center">
              <svg
                viewBox="0 0 24 24"
                width="24"
                height="24"
          ...
          <li className="w-24 h-14 flex justify-center items-center cursor-pointer mx-1">
            <div className="w-full h-5/6 hover:bg-gray-200 rounded-md flex justify-center items-center">
              <svg
                viewBox="0 0 24 24"
                width="24"
                height="24"
      ...
      <div>
        <ul className="flex">
          <li className="w-10 h-10 flex justify-center items-center bg-gray-200 rounded-full m-1 cursor-pointer hover:bg-gray-300">
            <svg
              viewBox="0 0 24 24"
              width="20"
              height="20"
